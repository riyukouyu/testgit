...
public class mnvcbk {
	...
	private static final BizLog bizlog = BizLogUtil.getBizLog(mnvcbk.class);
	
	public static void befroeCheck( final cn.sunline.ltts.busi.intran.trans.intf.Mnvcbk.Input input){
		...
		//内部账转客户账输入检查
		iavcbk.inputCheck(iavcbkInput, E_CMBKTP.UPD);
