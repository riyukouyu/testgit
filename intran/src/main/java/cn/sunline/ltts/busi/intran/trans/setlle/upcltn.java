...
public class upcltn {
	...
	public static void CheckTransfAfter( final cn.sunline.ltts.busi.intran.trans.intf.Upcltn.Input Input,  final cn.sunline.ltts.busi.intran.trans.intf.Upcltn.Property Property,  final cn.sunline.ltts.busi.intran.trans.intf.Upcltn.Output Output){
		//平衡性检查 开关开时检查
	...
	public static void chkTransfBefore( final cn.sunline.ltts.busi.intran.trans.intf.Upcltn.Input Input,  final cn.sunline.ltts.busi.intran.trans.intf.Upcltn.Property Property,  final cn.sunline.ltts.busi.intran.trans.intf.Upcltn.Output Output){
