...
public class fnsreg {
	...
	public static void beforeRegister( final cn.sunline.ltts.busi.intran.trans.intf.Fnsreg.Input Input,  final cn.sunline.ltts.busi.intran.trans.intf.Fnsreg.Output Output){
		//录入日期
