...
import cn.sunline.edsp.busi.dptran.trans.ca.jfca.intf.Exqra.Output.Exportlist;
...
public class exqra {
	...
	// 初始化日志信息
	private static BizLog bizlog = BizLogUtil.getBizLog(exqra.class);

	public static void exportQratinList(final cn.sunline.edsp.busi.dptran.trans.ca.jfca.intf.Exqra.Input input,
			final cn.sunline.edsp.busi.dptran.trans.ca.jfca.intf.Exqra.Property property,
			final cn.sunline.edsp.busi.dptran.trans.ca.jfca.intf.Exqra.Output output) {
		bizlog.method("exqra begin >>>>>>>>>>>>>>>>>>>>>>");
		...
		for (DpAcctinIoblCupsExp dpAcctinIoblCupsExp : knlIoblCupsInfoExps) {
			Exportlist data = SysUtil
					.getInstance(cn.sunline.edsp.busi.dptran.trans.ca.jfca.intf.Exqra.Output.Exportlist.class);
