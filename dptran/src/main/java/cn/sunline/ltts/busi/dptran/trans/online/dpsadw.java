...
public class dpsadw {
	...
	public static void dpsadwCheck(
			final cn.sunline.ltts.busi.dptran.trans.online.intf.Dpsadw.Input Input,
			final cn.sunline.ltts.busi.dptran.trans.online.intf.Dpsadw.Property Property,
			final cn.sunline.ltts.busi.dptran.trans.online.intf.Dpsadw.Output Output) {
		...
		// throw InError.comm.E0005("客户账户");
		// }
		// if (CommUtil.isNull(Input.getFronsq())) {
		// throw InError.comm.E0005("前置流水");
		// }
		// if (CommUtil.isNull(Input.getFrondt())) {
		// throw InError.comm.E0005("前置日期");
		// }
		...
		Property.setToacct(acctOut.getAcctno());
	}
}
