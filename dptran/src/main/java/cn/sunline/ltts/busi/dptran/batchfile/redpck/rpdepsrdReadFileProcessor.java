...
public class rpdepsrdReadFileProcessor
		extends
		ReadFileProcessor<cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Input, cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Property, cn.sunline.ltts.busi.aplt.tables.online.SysFileTables.kapb_wjplxxb, cn.sunline.ltts.busi.dp.tables.RpMgr.KnbRptrBach, cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.postalrd.Foot> {
	...
	public String downloadFile(
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Input input,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Property property) {
		...
		log.debug("文件类型:" + E_FILETP.DP020400.getLongName());
		log.debug("<<===========================>>");		
		// TODO:执行文件下载
	 ...
	 * 
	 */
	public boolean headerProcess(
			cn.sunline.ltts.busi.aplt.tables.online.SysFileTables.kapb_wjplxxb mapping,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Input input,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Property property) {
		log.debug("<<===========================>>");
		log.debug("文件头处理");
		log.debug("<<===========================>>");
		// mapping.setChenggbs(0L);
		// mapping.setPlwenjzt(E_PLWENJZT.PARSEING);
		// mapping.setShibaibs(0L);
	 ...
	 */
	public boolean bodyProcess(
			int index,
			cn.sunline.ltts.busi.dp.tables.RpMgr.KnbRptrBach mapping,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Input input,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Property property) {
		log.debug("<<=============文件体解析处理==============>>");
	 ...
	 * @return 后续是否执行自动入库操作。该返回值仅在配置了mapping属性后才有效。
	 */
	public boolean footProcess(
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.postalrd.Foot foot,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Input input,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Property property) {
		// TODO
		return false;
	 ...
	 * @param property
	 */
	public void beforeReadFileTranProcess(
			String taskId,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Input input,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Property property) {
		log.debug("<<=============读文件前进行处理==============>>");
	 ...
	 * @param property
	 */
	public void headerResolveExceptionProcess(
			String taskId,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Input input,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Property property,
			Throwable t) {
	 ...
	 * @param addErrorCount
	 */
	public void afterBodyResolveCommitProcess(
			String taskId,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Input input,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Property property,
	 ...
	 * @param t
	 */
	public void bodyResolveExceptionProcess(
			String taskId,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Input input,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Property property,
	 ...
	 * @param property
	 */
	public void afterReadFileTranProcess(
			String taskId,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Input input,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Property property) {
		log.debug("<<=============文件处理完成后处理==============>>");
		Long total = RpBatchTransDao.selCountByFilesq(tblkapbWjplxxb.getBtchno(), tblkapbWjplxxb.getAcctdt(), false);
	 ...
	 * @param totalErrorCount
	 */
	public void afterBodyResolveProcess(
			String taskId,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Input input,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Property property,
			String jobId, int totalSuccessCount, int totalErrorCount) {
	 ...
	 * @param t
	 */
	public void readFileTranExceptionProcess(
			String taskId,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Input input,
			cn.sunline.ltts.busi.dptran.batchfile.redpck.intf.Rpdepsrd.Property property,
			Throwable t) {
