...
public class cardhbDataProcessor extends
  BatchDataProcessorWithoutDataItem<cn.sunline.ltts.busi.dptran.batchtran.intf.Cardhb.Input, cn.sunline.ltts.busi.dptran.batchtran.intf.Cardhb.Property> {
	 ...
	 */
	 @Override
	public void process(cn.sunline.ltts.busi.dptran.batchtran.intf.Cardhb.Input input, cn.sunline.ltts.busi.dptran.batchtran.intf.Cardhb.Property property) {
		 ...
		 String header = totanm +"|@|"+distnm+"|@|"+succnm+"|@|"+failnm+"\n";
