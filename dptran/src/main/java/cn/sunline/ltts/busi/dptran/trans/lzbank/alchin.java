...
import cn.sunline.ltts.busi.dptran.trans.lzbank.intf.Alchin.Input;
import cn.sunline.ltts.busi.dptran.trans.lzbank.intf.Alchin.Output;
import cn.sunline.ltts.busi.dptran.trans.lzbank.intf.Alchin.Property;
...
public class alchin {
	 ...
	 * @param output
	 */
	public static void dealAlchin( final cn.sunline.ltts.busi.dptran.trans.lzbank.intf.Alchin.Input input,  final cn.sunline.ltts.busi.dptran.trans.lzbank.intf.Alchin.Property property,  final cn.sunline.ltts.busi.dptran.trans.lzbank.intf.Alchin.Output output){
		...
		E_CAPITP capitp =  E_CAPITP.IN111;//资金交易类型-银联全渠道转入
...
//			entity.setDescrb("银联全渠道转入成功");//交易信息   
