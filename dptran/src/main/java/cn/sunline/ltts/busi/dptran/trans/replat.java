...
public class replat {
	...
	public static void registeredPlatform(
		...
		String platno = CommTools.getBaseRunEnvs().getTrxn_branch() + input.getPlatno();
		KnbPlatInfo selKnbPlatInfo = KnbPlatInfoDao.selectOne_odb1(platno, false);
		if (CommUtil.isNotNull(selKnbPlatInfo)) {
			throw DpModuleError.DpstProd.E0010("平台信息已存在！");
		}
