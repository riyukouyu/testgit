...
public class sealou {
	...
	public static void CheckTransBefore( final cn.sunline.ltts.busi.dptran.trans.debt.intf.Sealou.Input input,  final cn.sunline.ltts.busi.dptran.trans.debt.intf.Sealou.Property property,  final cn.sunline.ltts.busi.dptran.trans.debt.intf.Sealou.Output output){
		//1、参数不能为空
	...
	public static void CheckTransAfter( final cn.sunline.ltts.busi.dptran.trans.debt.intf.Sealou.Input input,  final cn.sunline.ltts.busi.dptran.trans.debt.intf.Sealou.Property property,  final cn.sunline.ltts.busi.dptran.trans.debt.intf.Sealou.Output output){
