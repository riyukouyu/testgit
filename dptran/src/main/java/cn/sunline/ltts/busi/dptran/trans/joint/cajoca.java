...
public class cajoca {
	...
	public static void beforeMethod(
			final cn.sunline.ltts.busi.dptran.trans.joint.intf.Cajoca.Input input,
			final cn.sunline.ltts.busi.dptran.trans.joint.intf.Cajoca.Property property,
			final cn.sunline.ltts.busi.dptran.trans.joint.intf.Cajoca.Output output) {
		...
		DpCheckPubic.chkJointInfo(custac, platno, tranam, E_JOTRTP.TX);
		...
		//获取转出方子账号
		String acctno = CaTools.getAcctno(custac, null);
		...
		property.setAmondr(E_AMONDR.DOWN);
