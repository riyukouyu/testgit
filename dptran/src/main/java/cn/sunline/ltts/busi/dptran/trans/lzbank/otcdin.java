...
import cn.sunline.ltts.busi.dptran.trans.lzbank.intf.Otcdin.Input;
import cn.sunline.ltts.busi.dptran.trans.lzbank.intf.Otcdin.Output;
import cn.sunline.ltts.busi.dptran.trans.lzbank.intf.Otcdin.Property;
...
public class otcdin {
	 ...
	 * @param output
	 */
	public static void dealOtcdin( final cn.sunline.ltts.busi.dptran.trans.lzbank.intf.Otcdin.Input input,  final cn.sunline.ltts.busi.dptran.trans.lzbank.intf.Otcdin.Property property,  final cn.sunline.ltts.busi.dptran.trans.lzbank.intf.Otcdin.Output output){
...
//      clerinfo.setClerst(clerst);//数据同步标志                                   
	 ...
	 * @param input
	 */
	private static void chkParam(final Input input){
...
//                
	 ...
	 * @param input 
	 */
	public static void sendMessage(Input input, Property property, Output output){
