...
public class sencou {
	...
	public static void CheckTransBefore( final cn.sunline.ltts.busi.dptran.trans.debt.intf.Sencou.Input input,  final cn.sunline.ltts.busi.dptran.trans.debt.intf.Sencou.Property property,  final cn.sunline.ltts.busi.dptran.trans.debt.intf.Sencou.Output output){
		// 1、参数不能为空
		// (不验密)
		// if(CommUtil.isNull(input.getPasswd())){
		// throw InError.comm.E0005("交易密码");
		// }
	...
	public static void CheckTransAfter( final cn.sunline.ltts.busi.dptran.trans.debt.intf.Sencou.Input input,  final cn.sunline.ltts.busi.dptran.trans.debt.intf.Sencou.Property property,  final cn.sunline.ltts.busi.dptran.trans.debt.intf.Sencou.Output output){
		// 平衡性检查 开关开时检查
