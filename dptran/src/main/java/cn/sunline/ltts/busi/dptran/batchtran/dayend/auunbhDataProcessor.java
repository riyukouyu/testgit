...
public class auunbhDataProcessor extends
  AbstractBatchDataProcessor<cn.sunline.ltts.busi.dptran.batchtran.dayend.intf.Auunbh.Input, cn.sunline.ltts.busi.dptran.batchtran.dayend.intf.Auunbh.Property, cn.sunline.ltts.busi.dp.tables.DpFroz.KnbFroz> {
	  /**
		 * 批次数据项处理逻辑。
		 * 
		 * @param job 批次作业ID
		 ...
		 */
		@Override
		public void process(String jobId, int index, cn.sunline.ltts.busi.dp.tables.DpFroz.KnbFroz dataItem, cn.sunline.ltts.busi.dptran.batchtran.dayend.intf.Auunbh.Input input, cn.sunline.ltts.busi.dptran.batchtran.dayend.intf.Auunbh.Property property) {
			...
			//外部止付才有紧急止付
			if(dataItem.getFroztp() != E_FROZTP.CUSTSTOPAY){
				throw DpModuleError.DpstComm.E9999("该记录不是账户保护");
			}
			...
			dpUnStopayIn.setStoptp(E_STOPTP.CUSTSTOPAY); //止付类型
...
//			dpUnStopayIn.setIdno02(dataItem.getIdno01()); //执法人员2证件号码
			dpUnStopayIn.setSfreas("客户止付到期解止"); //解/止付原因
		 ...
		 */
		@Override
		public BatchDataWalker<cn.sunline.ltts.busi.dp.tables.DpFroz.KnbFroz> getBatchDataWalker(cn.sunline.ltts.busi.dptran.batchtran.dayend.intf.Auunbh.Input input, cn.sunline.ltts.busi.dptran.batchtran.dayend.intf.Auunbh.Property property) {
			Params params = new Params();
			params.add("frozst", E_FROZST.VALID);
			params.add("froztp",  E_FROZTP.CUSTSTOPAY);
			...
			return new CursorBatchDataWalker<KnbFroz>(DpDayEndDao.namedsql_selKnbFrozByProtect, params);
		}
